...
<?php
    //check whether if is set or not
    if(isset($_GET['id'])){
        //get all the details
        $id = $_GET['id'];

        //sql query to get the selected product
        $sql2 = "SELECT * FROM tbl_water  WHERE id=$id";
        ...
        //get the individual value of the selected product
        $title = $row2['title'];
    ...
    <div class="wrapper">
                    ...
                    <td>
                        <?php
                            if($current_image==""){
                                ...
                                //image available
                                ?>
                                <img src="<?php echo SITEURL;?>images/product/<?php echo $current_image;?>" width="235px">
                                <?php
                            }
                        ?>
                    </td>
        ...
        <?php
            if(isset($_POST['submit'])){
                ...
                //4. update the profuct in the database
                $sql3 = "UPDATE tbl_water SET
                    title = '$title',
